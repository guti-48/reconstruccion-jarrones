...
class Config:
    ...
    PATH = './checkpoints'
    DATA_ROOT = '/content/data_rapida/processed' #Ruta Google Colab
    GAN_LOSS = 'nsgan'
    LR = 0.0001
    D2G_LR = 0.1
    BETA1 = 0.0
...
def train_gan():
    ...
    if config.START_EPOCH > 1:
        ...
        if os.path.exists(ruta_gen) and os.path.exists(ruta_dis):
            # Cargamos los "maletines" enteros a la memoria
            ...
            # Extraemos SOLO los pesos reales ignorando el número de iteración
            ...
            # Le inyectamos los pesos limpios a los modelos
            ...
            print("Error: No se encontraron los archivos .pth en la carpeta checkpoints.")
